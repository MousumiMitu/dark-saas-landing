  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute h-5 w-5 left-full top-1/2 -translate-x-1/2 -translate-y-1/2 border border-white rounded-full inline-flex items-center justify-center">
      ...
      <motion.div
        ...
        className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px]   rounded-full border border-white/20 border-dashed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
      "
      ></motion.div>
      {/* start ring 3 */}
      <motion.div
      ...
      <div className="container relative mt-16">
        <h1 className="text-8xl md:text-[168px]  md:leading-none font-semibold tracking-tight bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,198,.5))] bg-clip-text text-transparent text-center">
          {" "}
          AI SEO
        </h1>
